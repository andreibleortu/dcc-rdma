...
#include "lambda/lambda.h"  // Add this include

#define MAX_CQ_ENTRIES 10
#define TIMEOUT 14
...
{
	// Add error string conversion
	static const char *err_strings[] = { [RDMA_SUCCESS] = "Success",
...
struct config_t *global_config = NULL;
...
// Generic run functions that dispatch to mode-specific implementations
